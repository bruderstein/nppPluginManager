...
RunStep::RunStep(const TCHAR *file, const TCHAR *arguments, BOOL outsideNpp, const CHAR *proxy, const long proxyPort)
	: _file(file), 
							 ...
							 const HWND windowParent)
{
	...
	switch(Validator::validate(executable, _proxy.c_str(), _proxyPort))
	{
